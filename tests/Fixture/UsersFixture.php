...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'verfuegernummer' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'verfuegername' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'school_id' => 1,
                'verfuegernummer' => 1,
                'verfuegername' => 'Lorem ipsum dolor sit amet',
                'password' => 'Lorem ipsum dolor sit amet',
                'active' => 1,
                'admin' => 1,
                'created' => '2019-09-17 09:09:59',
                'modified' => '2019-09-17 09:09:59'
            ],
        ];
        parent::init();
    }
